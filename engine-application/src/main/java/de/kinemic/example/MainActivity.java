...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mEngine = ((EngineApplication) getApplication()).getEngine();
  }
  ...
  protected void onDestroy() {
    ...
    // Release the engine (which also disconnects connected sensors) when our activity gets destroyed
    ((EngineApplication) getApplication()).releaseEngine();
  }
